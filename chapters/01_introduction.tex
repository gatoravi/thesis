...
We have made a lot of progress in identifying loci that are associated with the mean level of expression \cite{gtex} \cite{eqtlgen} \cite{more}. These studies have identified eQTLs for almost every gene in the genome \cite{} About half of all GWAS hits can now be mapped to eQTLs \cite{}. However this only looks at the mean level of expression. Could a similar approach be used to find loci that find variance QTLs?
...
\begin{figure}[t!]  
    ...
    \includegraphics[width=\linewidth]{figures/intro/intro_outlier1.png}
...
\begin{figure}[t!]  
    ...
    \phantomlabel{fig:cas_figure6b}
    \phantomlabel{fig:cas_figure6c}
    \includegraphics[width=\linewidth]{figures/intro/intro_gfp_density_X.pdf}
    \caption[SARGENT measures the insertion effect of a transgene.]{%
        \textbf{SARGENT measures the insertion effect of a transgene.}
        \subref{fig:cas_figure6a}
        Schematic for expression change detection in the transcriptome data.
...
\begin{figure}[t!]  
    ...
    \phantomlabel{fig:cas_figure6b}
    \phantomlabel{fig:cas_figure6c}
    \includegraphics[width=\linewidth]{figures/intro/intro_aim1_task1.pdf}
    \caption[SARGENT measures the insertion effect of a transgene.]{%
        \textbf{SARGENT measures the insertion effect of a transgene.}
        \subref{fig:cas_figure6a}
        Schematic for expression change detection in the transcriptome data.
