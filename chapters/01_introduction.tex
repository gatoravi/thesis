...
The studies cited in this section have looked for signatures of selection acting specifically on the noise level. However for some of these studies it is impossible to attribute this signal entirely to the variability, and not to the mean. Indeed, most of these studies don't rule out alternative explanations for the signals of selection that are observed in the discussion sections.
...
It remains to be well understood how the noise in the upstream regulators of a pathway propagates through a pathway. Chang et al. \cite {sui_huang} showed that the variation in the transcription factor \emph{Sca1}  can have an effect on which way a cell differentiates.
...
\section{Recent developments in the noise field}
