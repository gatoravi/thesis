...
\begin{suppfigure}[p]  
    ...
    \caption[Raw data for the Prrx1 induced and uninduced cells shown in Figure 3A]{
        Raw cytometer plots for the data summarized in Figure 3A. Prrx1 inducible cells were grown in the presence and absence of Dox, treated with SAG and run on a cytometer at 32 hours. Three biological replicates were used for each condition.  
    }
